CREATE TABLE "mail0_imap_smtp_config" (
	...
	"smtp_require_tls" boolean DEFAULT true NOT NULL,
	"imap_username" text NOT NULL,
	"encrypted_password" text NOT NULL,
	"sent_folder" text DEFAULT 'Sent' NOT NULL,
	"trash_folder" text DEFAULT 'Trash' NOT NULL,
	"drafts_folder" text DEFAULT 'Drafts' NOT NULL,
	"spam_folder" text DEFAULT 'Junk' NOT NULL,
	"sync_cursor" jsonb DEFAULT 'null'::jsonb,
	"last_sync_at" timestamp,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "mail0_imap_smtp_config_connection_id_unique" UNIQUE("connection_id")
);
...
ALTER TABLE "mail0_imap_smtp_config" ADD CONSTRAINT "mail0_imap_smtp_config_connection_id_mail0_connection_id_fk" FOREIGN KEY ("connection_id") REFERENCES "public"."mail0_connection"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "imap_smtp_config_connection_id_idx" ON "mail0_imap_smtp_config" USING btree ("connection_id");--> statement-breakpoint
